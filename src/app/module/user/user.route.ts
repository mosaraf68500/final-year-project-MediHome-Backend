...
const createDoctorZodSchema= z.object({
    ...
    doctor: z.object({
        ...
        registratoinNumber: z.string().nonempty("registration number is required"),  
...
router.post("/create-doctor", (req: Request, res: Response, next: NextFunction) => { 
    ...
    if (!parseResult.success) {
       // return যোগ করা হয়েছে, এরর হলে কোড এখানেই থেমে যাবে
       return next(parseResult.error);
    }

    // ভ্যালিডেশন সফল হলে ডেটা ওভাররাইট করে পরের কন্ট্রোলারে যাবে
